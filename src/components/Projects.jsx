...
export default function Projects() {
  const projects = [
    ...
    },
    {
      title: "KoalaQuest",
      description:
        "Interactive educational adventure platform designed for Prep to Year 2 students following the Queensland Curriculum (QCAA). Features four learning worlds, story-driven quests, XP progression, coins, pets, unlockable themes, parent dashboard, learning analytics, weekly reports, responsive design, and accessibility improvements based on real user feedback.",
      tech: [
        "React",
        "JavaScript",
        "Vite",
      ...
      link: "https://koalaquest.netlify.app/",
      caseStudy: "/case-study/koalaquest",
    },
    {
